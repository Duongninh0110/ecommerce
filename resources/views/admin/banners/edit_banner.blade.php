        ...
        <div class="span12">
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              <form class="form-horizontal" method="post" action="{{url('/admin/edit-banner/'.$banner->id)}}" name="edit_banner" id="edit_banner" enctype="multipart/form-data">
              	@csrf
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    ...
                    <img src="{{asset('/images/frontend_images/banners/'.$banner->image)}}" style="width:100px" alt="">
                  </div>
                </div>
